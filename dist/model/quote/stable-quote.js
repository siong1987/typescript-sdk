...
function addExtraLPFees(outputTradeAmount, params) {
    ...
    if (feeStructure.traderFee.numerator !== public_1.ZERO) {
        denominator = denominator.sub(feeStructure.traderFee.numerator.mul(dust).div(feeStructure.traderFee.denominator));
    }
    if (feeStructure.ownerFee.numerator !== public_1.ZERO) {
        denominator = denominator.sub(feeStructure.ownerFee.numerator.mul(dust).div(feeStructure.ownerFee.denominator));
    }
