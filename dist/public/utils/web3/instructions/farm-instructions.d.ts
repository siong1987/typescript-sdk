...
export declare const createInitUserFarmInstruction: (
  farm: Aquafarm,
  userFarmPublicKey: PublicKey,
  owner: Owner
) => Promise<Instruction>;
export declare const createFarmConvertTokensInstruction: (
  farm: Aquafarm,
...
export declare const createFarmRevertTokensInstruction: (
  farm: Aquafarm,
...
export declare const createFarmHarvestRewardInstruction: (
  farm: Aquafarm,
  userRewardTokenPublicKey: PublicKey,
  owner: Owner
) => Promise<Instruction>;
